...
FSL_EULA_FILE=$CWD/sources/meta-myir/EULA
...
echo "BBLAYERS += \"\${BSPDIR}/sources/meta-pleiades\"" >> $BUILD_DIR/conf/bblayers.conf
echo "BBLAYERS += \"\${BSPDIR}/sources/meta-pleiades-arcturus\"" >> $BUILD_DIR/conf/bblayers.conf
