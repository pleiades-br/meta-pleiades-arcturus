...
SRC_URI:append:plds-myd-y6ull = " \
    file://dts/myd-imx6ull-base-arcturus.dts \
...
copy_arcturus_files() {
    cp -f dts/myd-imx6ull-base-arcturus.dts dts/myd-y6ull-emmc-arcturus.dts dts/myd-y6ull-gpmi-weim-arcturus.dts ${S}/arch/arm/boot/dts
